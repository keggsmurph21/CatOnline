...
_STATE_GRAPH = {
    ...
    "edges": {
        ...
        "_e_discard_move_robber": {
            ...
            "listen": "tile",
            "confirm": "Are you sure you want to move the robber here?",
        ...
        "_e_take_turn": {
            ...
            "activate": "",
            "description": "",
            "onSuccess": "function () { alert(`It's your turn!`); }",
            "isCancel": False,
            "label": ""
        },
        "_e_to_root": {
