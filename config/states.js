module.exports = {
   ...
   edges: {
      ...
      "_e_build_city": {
         ...
         execute: function (g,p,a) { require(`../app/logic`).helpers.fortify(g,p,a[0]) },
         isPriority: false,
         isMulti: false,
         isCancel: false,
         label: ""
      ...
      "_e_build_road": {
         ...
         arguments: "road",
         execute: function (g,p,a) {require(`../app/logic`).helpers.pave(g,p,a[0]); },
         isPriority: false,
         isMulti: false,
         isCancel: false,
         label: ""
      ...
      "_e_build_settlement": {
         ...
         arguments: "settlement",
         execute: function (g,p,a) { require(`../app/logic`).helpers.settle(g,p,a[0]); },
         isPriority: false,
         isMulti: false,
         isCancel: false,
         label: ""
      ...
      "_e_discard_move_robber": {
         ...
         arguments: "hex",
         execute: function (g,p,a) { require(`../app/logic`).helpers.moveRobber(g,p,a[0]); },
         isPriority: false,
         isMulti: false,
         isCancel: false,
         label: ""
      ...
      "_e_end_game": {
         ...
         arguments: "",
         execute: function (g,p,a) { require(`../app/logic`).helpers.endGame(g); },
         isPriority: true,
         isMulti: false,
         isCancel: false,
         label: ""
      ...
      "_e_end_init": {
         ...
         arguments: "",
         execute: function (g,p,a) { require(`../app/logic`).helpers.iterateTurn(g) },
         isPriority: true,
         isMulti: false,
         isCancel: false,
         label: ""
      ...
      "_e_init_build_road": {
         ...
         arguments: "road",
         execute: function (g,p,a) { require(`../app/logic`).helpers.initPave(g,p,a[0]); },
         isPriority: false,
         isMulti: false,
         isCancel: false,
         label: ""
      ...
      "_e_init_settle": {
         ...
         evaluate: function (f) { return f.isFirstTurn || f.isSecondTurn; },
         arguments: "settlement",
         execute: function (g,p,a) { require(`../app/logic`).helpers.initSettle(g,p,a[0]); },
         isPriority: false,
         isMulti: false,
         isCancel: false,
         label: ""
      ...
      "_e_offer_trade": {
         ...
         arguments: "trade",
         execute: function (g,p,a) { require(`../app/logic`).helpers.validateTrade(g,p,a); require(`../app/logic`).helpers.offerTrade(g,p,a); },
         isPriority: false,
         isMulti: false,
         isCancel: false,
         label: ""
      ...
      "_e_roll": {
         ...
         arguments: "",
         execute: function (g,p,a) { return require(`../app/logic`).helpers.roll(g, a[0], a[1]); },
         isPriority: false,
         isMulti: false,
         isCancel: false,
         label: ""
      ...
      "_e_roll_discard": {
         ...
         arguments: "trade",
         execute: function (g,p,a) { require(`../app/logic`).helpers.discard(g,p,a.out); },
         isPriority: false,
         isMulti: true,
         isCancel: false,
         label: ""
      ...
      "_e_steal_robber": {
         ...
         evaluate: function (f) { return f.canSteal; },
         arguments: "player",
         execute: function (g,p,a) { require(`../app/logic`).helpers.steal(g,p,a[0]); },
         isPriority: false,
         isMulti: false,
         isCancel: false,
         label: ""
      ...
      "_e_trade_bank": {
         ...
         arguments: "trade",
         execute: function (g,p,a) { require(`../app/logic`).helpers.tradeWithBank(g,p,a); },
         isPriority: false,
         isMulti: false,
         isCancel: false,
         label: ""
