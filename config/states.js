...
module.exports = {
   ...
   edges: {
      ...
      "_e_build_road": {
         ...
         arguments: "road",
         execute: function (g,a) { let p=_.validatePlayer(g,a[0]), r=_.validateRoad(g,a[1]); _.pave(g,p,r); },
         isPriority: false,
         isMulti: false,
         isCancel: false,
         label: ""
      ...
      "_e_build_settlement": {
         ...
         arguments: "settlement",
         execute: function (g,a) { let p=_.validatePlayer(g,a[0]), j=_.validateJunc(g,a[1]); _.settle(g,p,j); },
         isPriority: false,
         isMulti: false,
         isCancel: false,
         label: ""
      ...
      "_e_buy_dc": {
         ...
         arguments: "",
         execute: function (g,a) { let p=_.validatePlayer(g,a[0]); _.buyDevCard(g,p); },
         isPriority: false,
         isMulti: false,
         isCancel: false,
         label: ""
      ...
      "_e_end_game": {
         ...
         arguments: "",
         execute: function (g,a) { _.endGame(g); },
         isPriority: true,
         isMulti: false,
         isCancel: false,
         label: ""
      ...
      "_e_init_build_road": {
         ...
         arguments: "road",
         execute: function (g,a) { let p=_.validatePlayer(g,a[0]), r=_.validateRoad(g,a[1]); _.initPave(g,p,r); },
         isPriority: false,
         isMulti: false,
         isCancel: false,
         label: ""
      ...
      "_e_init_settle": {
         ...
         evaluate: function (f) { return f.isFirstTurn || f.isSecondTurn; },
         arguments: "settlement",
         execute: function (g,a) { let p=_.validatePlayer(g,a[0]), j=_.validateJunc(g,a[1]); _.initSettle(g,p,j); },
         isPriority: false,
         isMulti: false,
         isCancel: false,
         label: ""
      ...
      "_e_knight_move_robber": {
         ...
         evaluate: function (f) { return true; },
         arguments: "hex",
         execute: function (g,a) { let p=_.validatePlayer(g,a[0]), h=_.validateHex(g,a[1]); _.playDC(g,p,'knight'); _.moveRobber(g,p,h); },
         isPriority: false,
         isMulti: false,
         isCancel: false,
         label: ""
      ...
      "_e_play_monopoly_choose": {
         ...
         evaluate: function (f) { return true; },
         arguments: "resource",
         execute: function (g,a) { let p=_.validatePlayer(g,a[0]), r=_.validateResource(g,a[1]); _.playDC(g,p,'monopoly',r); },
         isPriority: false,
         isMulti: false,
         isCancel: false,
         label: ""
      ...
      "_e_play_rb_choose": {
         ...
         evaluate: function (f) { return true; },
         arguments: "road road",
         execute: function (g,a) { let p=_.validatePlayer(g,a[0]), r=_.validateRoad(g,a[1]), s=_.validateRoad(g,a[2]); _.playDC(g,p,'rb',[r,s]); },
         isPriority: false,
         isMulti: false,
         isCancel: false,
         label: ""
      ...
      "_e_play_vp": {
         ...
         arguments: "",
         execute: function (g,a) { let p=_.validatePlayer(g,a[0]); _.playDC(g,p,'vp'); },
         isPriority: false,
         isMulti: false,
         isCancel: false,
         label: ""
      ...
      "_e_play_yop_choose": {
         ...
         execute: function (g,a) { let p=_.validatePlayer(g,a[0]), r=_.validateResource(g,a[1]), s=_.validateResource(g,a[2]); _.playDC(g,p,'yop',[r,s]); },
         isPriority: false,
         isMulti: false,
         isCancel: false,
         label: ""
